...
namespace Bit.Infrastructure.EntityFramework
{
    ...
    where T : DbContext
    {
        ...
        public DbSet<DomainModel.Grant> Grants { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            */
            ...
            builder.Entity<DomainModel.Device>().ToTable(nameof(DomainModel.Device));
            builder.Entity<DomainModel.Grant>(x => { x.HasKey(k => k.Key); x.ToTable(nameof(DomainModel.Grant)); });
        }
    }
}
